...
<html>
  ...
  <table border="1" width="60%" align="center">
 	...
 	<td>
	<c:if test="${act.state == 1}">通过</c:if>
  	<c:if test="${act.state == 3}">未通过</c:if>
  	<c:if test="${act.state == 2}">未审批</c:if>
	</td>
 		...
 		<td>审批意见：</td> 	
		<td><textarea name="idea" cols="40" rows="10"  style="border:1px solid black;">${app.idea }</textarea></td>	 
 		</tr>
